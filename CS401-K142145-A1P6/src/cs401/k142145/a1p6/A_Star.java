...
public class A_Star {
    ...
    //Attributes
     private Priority_Queue frontier ; // A* uses priority queue to keep frontier
    private int[][] maze ;
    ...
    public A_Star ( int[][] m , State i , State g , int r , int c  )
    {
        this.row = r ;
        this.column = c ;
    ...
    public void ASTAR_Run ( )
    {
        ...
        int fn = heuristic[initialState.getState_X()][initialState.getState_Y()] + 0;
        // f(n) = g(n) + h(n)
    ...
    {
          //Writing to a file
            FileWriter outfile = new FileWriter("A1P6out1.txt", false);
