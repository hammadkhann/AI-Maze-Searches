...
public class BFS {
    //Attributes
    private Queue<Node> frontier;       //Breadth-first search implements a queue for frontier
    private int[][] maze ;
    ...
    public BFS ( int[][] m , State i , State g , int r , int c  )
    {
    ...
    public void OptimalPath () throws IOException
       {
           //Writing to file
            FileWriter outfile = new FileWriter("A1P2out1.txt", false);
